...
class LocalCardsDataSource {
  final List<LsbCard> _cards = [
    ...
    LsbCard(id: 'de09', gloss: 'ANCIANO', displayText: 'ANCIANO', iconUrl: '',
      categoryId: 'Descripción', subcategoryId: 'Edad', contexts: ['denuncia_robo', 'violencia', 'accidente'],
    ...
    LsbCard(id: 'de11', gloss: 'DOS', displayText: 'DOS PERSONAS', iconUrl: '',
      categoryId: 'Descripción', subcategoryId: 'Cantidad', contexts: ['denuncia_robo', 'violencia'],
      priority: 11, suggestedNextCardIds: [], isFrequent: true, isEmergency: false, semanticIcon: 'people'),
    LsbCard(id: 'de12', gloss: 'TRES_MAS', displayText: 'TRES O MÁS', iconUrl: '',
      categoryId: 'Descripción', subcategoryId: 'Cantidad', contexts: ['denuncia_robo', 'violencia'],
    ...
    LsbCard(id: 'df03', gloss: 'DELGADO', displayText: 'DELGADO', iconUrl: '',
    ...
    LsbCard(id: 'dv05', gloss: 'CAMISETA', displayText: 'CAMISETA/POLERA', iconUrl: '',
      categoryId: 'Descripción', subcategoryId: 'Vestimenta', contexts: ['denuncia_robo', 'violencia'],
    ...
    LsbCard(id: 'dv07', gloss: 'ZAPATILLAS', displayText: 'ZAPATILLAS', iconUrl: '',
      categoryId: 'Descripción', subcategoryId: 'Vestimenta', contexts: ['denuncia_robo', 'violencia'],
    ...
    LsbCard(id: 'ob16', gloss: 'LAPTOP', displayText: 'LAPTOP/COMPUTADORA', iconUrl: '',
