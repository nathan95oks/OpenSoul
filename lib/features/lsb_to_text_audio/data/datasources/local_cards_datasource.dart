...
class LocalCardsDataSource {
  final List<LsbCard> _cards = [
    ...
    LsbCard(id: 'id02', gloss: 'HIJO', displayText: 'HIJO', iconUrl: '',
    ...
    LsbCard(id: 'ac07', gloss: 'INSCRIBIR', displayText: 'INSCRIBIR', iconUrl: '',
    ...
    LsbCard(id: 'ac08', gloss: 'REGISTRAR', displayText: 'REGISTRAR', iconUrl: '',
      categoryId: 'Acciones', subcategoryId: 'Gestión', contexts: ['municipio'],
      priority: 8, suggestedNextCardIds: ['in03','do01'], isFrequent: true, isEmergency: false, semanticIcon: 'how_to_reg'),
    LsbCard(id: 'ac09', gloss: 'RECOGER', displayText: 'RECOGER', iconUrl: '',
    ...
    LsbCard(id: 'tr02', gloss: 'INSCRIPCION', displayText: 'INSCRIPCIÓN', iconUrl: '',
    ...
    LsbCard(id: 'tr03', gloss: 'REGISTRO', displayText: 'REGISTRO', iconUrl: '',
      categoryId: 'Trámites', subcategoryId: 'Gestión', contexts: ['municipio'],
    ...
    LsbCard(id: 'tr07', gloss: 'CITA', displayText: 'CITA', iconUrl: '',
      categoryId: 'Trámites', subcategoryId: 'Programación', contexts: ['salud','general'],
      priority: 5, suggestedNextCardIds: ['in07','ti01'], isFrequent: true, isEmergency: false, semanticIcon: 'event'),
    LsbCard(id: 'tr08', gloss: 'TURNO', displayText: 'TURNO', iconUrl: '',
      categoryId: 'Trámites', subcategoryId: 'Programación', contexts: ['general'],
      priority: 6, suggestedNextCardIds: [], isFrequent: true, isEmergency: false, semanticIcon: 'confirmation_number'),
    LsbCard(id: 'tr09', gloss: 'DUPLICADO', displayText: 'DUPLICADO', iconUrl: '',
      categoryId: 'Trámites', subcategoryId: 'Gestión', contexts: ['municipio'],
      priority: 7, suggestedNextCardIds: ['do04','do01'], isFrequent: true, isEmergency: false, semanticIcon: 'content_copy'),
    ...
    LsbCard(id: 'do03', gloss: 'FORMULARIO', displayText: 'FORMULARIO', iconUrl: '',
      categoryId: 'Documentos', subcategoryId: 'Oficial', contexts: ['municipio'],
    ...
    LsbCard(id: 'do06', gloss: 'CERTIFICADO_MATRIMONIO', displayText: 'CERT. MATRIM.', iconUrl: '',
      categoryId: 'Documentos', subcategoryId: 'Civil', contexts: ['municipio'],
      priority: 6, suggestedNextCardIds: ['in03'], isFrequent: true, isEmergency: false, semanticIcon: 'favorite'),
    LsbCard(id: 'do07', gloss: 'CERTIFICADO_DEFUNCION', displayText: 'CERT. DEFUNC.', iconUrl: '',
      categoryId: 'Documentos', subcategoryId: 'Civil', contexts: ['municipio'],
    ...
    LsbCard(id: 'do10', gloss: 'FOTOCOPIA', displayText: 'FOTOCOPIA', iconUrl: '',
      categoryId: 'Documentos', subcategoryId: 'General', contexts: ['general'],
      priority: 10, suggestedNextCardIds: [], isFrequent: true, isEmergency: false, semanticIcon: 'content_copy'),
    LsbCard(id: 'do11', gloss: 'PASAPORTE', displayText: 'PASAPORTE', iconUrl: '',
      categoryId: 'Documentos', subcategoryId: 'Identificación', contexts: ['municipio'],
      priority: 11, suggestedNextCardIds: [], isFrequent: true, isEmergency: false, semanticIcon: 'flight'),
    LsbCard(id: 'do12', gloss: 'ANTECEDENTES', displayText: 'ANTECEDENTES', iconUrl: '',
      categoryId: 'Documentos', subcategoryId: 'Oficial', contexts: ['municipio'],
      priority: 12, suggestedNextCardIds: [], isFrequent: true, isEmergency: false, semanticIcon: 'verified_user'),

    // ═══════════════════════════════════════════════════════════
    // CONSULTAS — Preguntas, reclamos y averiguaciones
    // ═══════════════════════════════════════════════════════════
    LsbCard(id: 'co01', gloss: 'CONSULTA', displayText: 'CONSULTA', iconUrl: '',
      categoryId: 'Consultas', subcategoryId: 'Información', contexts: ['general'],
      priority: 1, suggestedNextCardIds: ['sv06','in01'], isFrequent: true, isEmergency: false, semanticIcon: 'question_answer'),
    LsbCard(id: 'co02', gloss: 'RECLAMO', displayText: 'RECLAMO', iconUrl: '',
      categoryId: 'Consultas', subcategoryId: 'Queja', contexts: ['general'],
      priority: 2, suggestedNextCardIds: ['sv06','in01'], isFrequent: true, isEmergency: false, semanticIcon: 'feedback'),
    LsbCard(id: 'co03', gloss: 'PREGUNTA', displayText: 'PREGUNTA', iconUrl: '',
      categoryId: 'Consultas', subcategoryId: 'Información', contexts: ['general'],
      priority: 3, suggestedNextCardIds: ['sv02','sv06'], isFrequent: true, isEmergency: false, semanticIcon: 'help_outline'),
    LsbCard(id: 'co04', gloss: 'DUDA', displayText: 'DUDA', iconUrl: '',
      categoryId: 'Consultas', subcategoryId: 'Información', contexts: ['general'],
      priority: 4, suggestedNextCardIds: ['sv02','sv06'], isFrequent: true, isEmergency: false, semanticIcon: 'help'),
    LsbCard(id: 'co05', gloss: 'AVERIGUAR', displayText: 'AVERIGUAR', iconUrl: '',
      categoryId: 'Consultas', subcategoryId: 'Información', contexts: ['general'],
      priority: 5, suggestedNextCardIds: ['sv02','sv06'], isFrequent: true, isEmergency: false, semanticIcon: 'search'),
    LsbCard(id: 'co06', gloss: 'DENUNCIA', displayText: 'DENUNCIA', iconUrl: '',
      categoryId: 'Consultas', subcategoryId: 'Queja', contexts: ['general'],
      priority: 6, suggestedNextCardIds: ['in10','in11'], isFrequent: true, isEmergency: true, semanticIcon: 'report'),
    ...
    LsbCard(id: 'ti04', gloss: 'MAÑANA', displayText: 'MAÑANA', iconUrl: '',
    ...
    LsbCard(id: 'ti06', gloss: 'SEMANA', displayText: 'SEMANA', iconUrl: '',
    ...
    LsbCard(id: 'in02', gloss: 'GOBERNACION', displayText: 'GOBERNACIÓN', iconUrl: '',
      categoryId: 'Instituciones', subcategoryId: 'Gobierno', contexts: ['municipio'],
    ...
    LsbCard(id: 'in05', gloss: 'IMPUESTOS', displayText: 'IMPUESTOS', iconUrl: '',
    ...
    LsbCard(id: 'in06', gloss: 'BANCO', displayText: 'BANCO', iconUrl: '',
    ...
    LsbCard(id: 'in07', gloss: 'HOSPITAL', displayText: 'HOSPITAL', iconUrl: '',
    ...
    LsbCard(id: 'in08', gloss: 'ESCUELA', displayText: 'ESCUELA', iconUrl: '',
    ...
    LsbCard(id: 'in09', gloss: 'NOTARIA', displayText: 'NOTARÍA', iconUrl: '',
    ...
    LsbCard(id: 'in10', gloss: 'POLICIA', displayText: 'POLICÍA', iconUrl: '',
      ...
      priority: 10, suggestedNextCardIds: ['co02','co06'], isFrequent: true, isEmergency: true, semanticIcon: 'local_police'),
    LsbCard(id: 'in11', gloss: 'DEFENSORIA', displayText: 'DEFENSORÍA', iconUrl: '',
      ...
      priority: 11, suggestedNextCardIds: ['sv06','co02'], isFrequent: false, isEmergency: false, semanticIcon: 'shield'),
    LsbCard(id: 'in12', gloss: 'OFICINA', displayText: 'OFICINA', iconUrl: '',
    ...
    LsbCard(id: 'sv05', gloss: 'ATENCION', displayText: 'ATENCIÓN', iconUrl: '',
      categoryId: 'Servicios', subcategoryId: 'Atención', contexts: ['general'],
    ...
    LsbCard(id: 'eu07', gloss: 'PERDIDO', displayText: 'PERDIDO', iconUrl: '',
      categoryId: 'Estado/Urgencia', subcategoryId: 'Estado', contexts: ['general'],
      priority: 7, suggestedNextCardIds: ['sv02'], isFrequent: true, isEmergency: false, semanticIcon: 'location_off'),
  ];

  /// Orden predefinido de las 9 categorías ciudadanas.
