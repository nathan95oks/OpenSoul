...
class LocalCardsDataSource {
  final List<LsbCard> _cards = [
    ...
    LsbCard(id: 'dco01', gloss: 'NEGRO', displayText: 'NEGRO', iconUrl: '',
      ...
      priority: 1, suggestedNextCardIds: [], isFrequent: true, isEmergency: false, semanticIcon: 'circle'),
    LsbCard(id: 'dco02', gloss: 'BLANCO', displayText: 'BLANCO', iconUrl: '',
      categoryId: 'Descripción', subcategoryId: 'Color', contexts: ['denuncia_robo', 'violencia'],
      priority: 2, suggestedNextCardIds: [], isFrequent: true, isEmergency: false, semanticIcon: 'panorama_fish_eye'),
    LsbCard(id: 'dco03', gloss: 'AZUL', displayText: 'AZUL', iconUrl: '',
      categoryId: 'Descripción', subcategoryId: 'Color', contexts: ['denuncia_robo', 'violencia'],
      priority: 3, suggestedNextCardIds: [], isFrequent: true, isEmergency: false, semanticIcon: 'water_drop'),
    LsbCard(id: 'dco04', gloss: 'ROJO', displayText: 'ROJO', iconUrl: '',
      categoryId: 'Descripción', subcategoryId: 'Color', contexts: ['denuncia_robo', 'violencia'],
      priority: 4, suggestedNextCardIds: [], isFrequent: true, isEmergency: false, semanticIcon: 'favorite'),
    ...
    LsbCard(id: 'dco07', gloss: 'OSCURO', displayText: 'COLOR OSCURO', iconUrl: '',
      categoryId: 'Descripción', subcategoryId: 'Color', contexts: ['denuncia_robo', 'violencia'],
      priority: 7, suggestedNextCardIds: [], isFrequent: true, isEmergency: false, semanticIcon: 'brightness_3'),
    LsbCard(id: 'dco08', gloss: 'CLARO', displayText: 'COLOR CLARO', iconUrl: '',
      categoryId: 'Descripción', subcategoryId: 'Color', contexts: ['denuncia_robo', 'violencia'],
      priority: 8, suggestedNextCardIds: [], isFrequent: true, isEmergency: false, semanticIcon: 'brightness_5'),
    ...
    LsbCard(id: 'ob02', gloss: 'GANAR_DINERO', displayText: 'GANAR DINERO', iconUrl: '',
      categoryId: 'Objetos', subcategoryId: 'Personal', contexts: ['denuncia_robo', 'perdida'],
    ...
    // ═══════════════════════════════════════════════════════════
    LsbCard(id: 'do04', gloss: 'CARNE', displayText: 'CARNÉ', iconUrl: '',
