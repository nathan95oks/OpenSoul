...
import '../semantic_engine/local_sentence_assembler.dart' show kVictimMarker;
...
final preguntasContext = SemanticContext(
  ...
  zones: const [
    ...
    SemanticZone(
      ...
      question: '¿Ante quién o qué institución preguntas?',
      emoji: '🏛️',
      semanticWeight: 0.68,
      optional: true,
    ...
    SemanticZone(
      ...
      semanticWeight: 0.8,
      optional: true,
      cardCategories: ['Documentos', 'Objetos', 'Conceptos jurídicos', 'Lugares'],
      relatedZones: [],
    ),
  ],
);
...
final availableContexts = <SemanticContext>[
  ...
  SemanticContext(
    ...
    zones: const [
      ...
      SemanticZone(
        ...
        emoji: '💔',
        semanticWeight: 0.7,
        cardCategories: ['Estado y emoción'],
  ...
  SemanticContext(
    ...
    SemanticZone(
      ...
      emoji: '📋',
      semanticWeight: 0.9,
      cardCategories: ['Acciones'],
      relatedZones: ['tramite', 'documento', 'motivo'],
    ),
    SemanticZone(
      id: 'tramite',
      label: 'Trámite',
      hint: 'Qué trámite o caso',
      question: '¿Qué trámite necesitas?',
      emoji: '🧾',
      semanticWeight: 0.82,
      optional: true,
      cardCategories: ['Conceptos jurídicos'],
    ...
    SemanticZone(
      id: 'soporte',
      label: 'Soporte',
      hint: 'Papel o carpeta',
      question: '¿Qué soporte necesitas?',
      emoji: '🗂️',
      semanticWeight: 0.7,
      optional: true,
      cardCategories: ['Documentos'],
      ...
      relatedZones: ['tramite', 'donde'],
    ),
      SemanticZone(
      id: 'donde',
      label: 'Institución',
      hint: 'Ante qué institución',
      question: '¿Ante quién o qué institución quieres acudir?',
      emoji: '🏛️',
      semanticWeight: 0.6,
      cardCategories: ['Instituciones'],
      cardSubcategories: const ['institucion'],
      ...
      SemanticZone(
        id: 'apoyo',
        label: 'Apoyo',
        hint: 'Abogado, intérprete o ayuda',
        question: '¿Necesitas apoyo legal o de accesibilidad?',
        emoji: '🤝',
        semanticWeight: 0.5,
        optional: true,
        cardCategories: ['Instituciones'],
        cardSubcategories: ['servicio', 'Accesibilidad', 'Legal', 'Atención', 'Información'],
      ),
      SemanticZone(
        id: 'quien',
        label: 'Personas',
...
String resolveAssemblerContext(
  ...
  // El contexto de preguntas se conserva como dominio propio: no debe
  // colarse como orientación porque la salida cambia de intención.
