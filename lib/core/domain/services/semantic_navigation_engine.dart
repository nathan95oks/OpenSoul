...
class SemanticNavigationEngine {
  ...
  static const Map<String, List<String>> _glossTagTriggers = {
    'HERIDA': [EmotionalTag.dolor, EmotionalTag.urgente],
    'DOLOR': [EmotionalTag.dolor],
    'FRACTURA': [EmotionalTag.dolor, EmotionalTag.urgente],
    'HUESOS': [EmotionalTag.dolor],
    'PEGAR': [EmotionalTag.dolor, EmotionalTag.amenaza],
    'MALTRATAR': [EmotionalTag.dolor, EmotionalTag.amenaza],
    'VIOLENCIA': [EmotionalTag.amenaza, EmotionalTag.peligro],
    'ABUSAR': [EmotionalTag.amenaza, EmotionalTag.peligro],
    'AMENAZAR': [EmotionalTag.amenaza, EmotionalTag.peligro],
    'MIEDO': [EmotionalTag.miedo],
    'TRISTE': [EmotionalTag.dolor],
    'AUXILIO': [EmotionalTag.urgente, EmotionalTag.ayuda, EmotionalTag.peligro],
    'AYUDAR': [EmotionalTag.ayuda],
    'URGENTE': [EmotionalTag.urgente],
    'PROTEGER': [EmotionalTag.ayuda],
    'POLICIA': [EmotionalTag.ayuda],
    'HOSPITAL': [EmotionalTag.urgente, EmotionalTag.ayuda],
    'DOCTOR': [EmotionalTag.ayuda],
    'SEPDAVI': [EmotionalTag.ayuda],
    'SEPDEP': [EmotionalTag.ayuda],
    'LADRON': [EmotionalTag.amenaza],
    'ROBAR': [EmotionalTag.amenaza],
    'ENGAÑAR': [EmotionalTag.amenaza],
    'ENGANAR': [EmotionalTag.amenaza],
    'DANAR': [EmotionalTag.amenaza],
  };
