...
AVAILABLE_GLOSSES = {
    ...
    "ESCRIBIR", "EXIGIR", "GESTIONAR", "IDENTIFICAR", "IMPRIMIR", "JURAR",
    "MOSTRAR", "NARRAR", "OBSERVAR", "PEDIR", "PERDER", "PRESENTAR",
    "PROTEGER", "QUEJAR", "RECOGER", "RECONOCER", "RECORDAR", "SEGUIMIENTO",
    "SOLUCIONAR", "TRATAR",
