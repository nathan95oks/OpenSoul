...
AVAILABLE_GLOSSES = {
    ...
    "COORDINAR", "COPIAR", "CORREGIR", "CUMPLIR", "DECIDIR", "ENTREGAR",
    "ESCRIBIR", "EXIGIR", "GESTIONAR", "IDENTIFICAR", "IMPRIMIR", "JURAR",
    "MOSTRAR", "NARRAR", "OBSERVAR", "PAGAR", "PEDIR", "PERDER",
    "PRESENTAR", "PROTEGER", "QUEJAR", "RECOGER", "RECONOCER", "RECORDAR",
    "SEGUIMIENTO", "SOLUCIONAR", "TRATAR",
    ...
    "PRUEBA", "TAXI", "TELEFONO", "TREN", "TRUFI",
    # --- Comunicación (7) ---
