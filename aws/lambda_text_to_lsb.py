...
AVAILABLE_GLOSSES = {
    ...
    "QUIEN", "TU", "USTEDES", "YO",
    # --- Identificación (12) ---
    "EXPAREJA", "FAMILIAR", "HOMBRE", "IDENTIDAD", "LADRON", "MILITAR",
    "MUJER", "NOMBRE", "PAREJA", "SOLDADO", "TESTIGO", "VECINO",
    # --- Instituciones (19) ---
    "ABOGADO", "ALCALDIA", "ASISTENTE", "AUTORIDAD", "COORDINADOR", "DESPACHO",
    "DOCTOR", "ENFERMERA", "FISCAL", "GOBIERNO", "INSTITUCION", "INTERPRETE",
    "JUEZ", "MINISTERIO", "OFICIAL", "OFICINA", "ORGANO_JUDICIAL", "POLICIA",
    "VENTANILLA",
    # --- Conceptos jurídicos (27) ---
    "ACUERDO_SOCIAL", "ARTICULO", "AUDIENCIA", "CASO", "CITACION", "CODIGO",
    "CONFIRMACION", "CONTEXTO", "DECRETO_SUPREMO", "ESTADO", "EXPEDIENTE", "INVESTIGACION",
    "JUICIO", "JUSTICIA", "LEY", "NORMA", "NOTIFICACION", "NUREJ",
    "PERSONERIA_JURIDICA", "PODER", "REGLAMENTO", "REQUISITO", "RESOLUCION", "SUBSANACION",
    "TESTIMONIO", "TRAMITE", "WEBID",
    # --- Acciones (34) ---
    "ACLARAR", "ACOMPANAR", "ADMINISTRAR", "ANOTAR", "AVISAR", "CONFESAR",
    "CONOCER", "COORDINAR", "COPIAR", "CORREGIR", "CUMPLIR", "DECIDIR",
    "ENTREGAR", "ESCRIBIR", "EXIGIR", "GESTIONAR", "IDENTIFICAR", "IMPRIMIR",
    "JURAR", "MOSTRAR", "NARRAR", "OBSERVAR", "PAGAR", "PEDIR",
    "PERDER", "PRESENTAR", "PROTEGER", "QUEJAR", "RECOGER", "RECONOCER",
    "RECORDAR", "SEGUIMIENTO", "SOLUCIONAR", "TRATAR",
    ...
    # --- Documentos (22) ---
    "ANEXO", "ARCHIVADOR", "CARNET", "CARPETA", "CARTA", "CERTIFICADO",
    "COMPROBANTE", "CONSTANCIA", "FORMATO", "FORMULARIO", "FOTOCOPIA", "HOJA",
    "LICENCIA", "LICENCIA_DECONDUCIR", "MEMORIAL", "OBSERVACION", "PAPEL", "PASAPORTE",
    "RESPALDO", "SELLO", "TEXTO", "TITULO",
    # --- Objetos (18) ---
    "AUTO", "AVION", "BICICLETA", "BILLETERA", "CAMARA", "CUENTA",
    "DINERO", "FOTOGRAFIA", "MENSAJE", "MICRO", "MOCHILA", "MOTOCICLETA",
    "PRODUCTO", "PRUEBA", "TAXI", "TELEFONO", "TREN", "TRUFI",
    # --- Comunicación (7) ---
