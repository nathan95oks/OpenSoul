...
AVAILABLE_GLOSSES = {
    ...
    "MOSTRAR", "NARRAR", "OBSERVAR", "PEDIR", "PRESENTAR", "PROTEGER",
    "QUEJAR", "RECOGER", "RECONOCER", "RECORDAR", "SEGUIMIENTO", "SOLUCIONAR",
    "TRATAR",
    ...
    # --- Documentos (21) ---
    "ANEXO", "ARCHIVADOR", "CARPETA", "CARTA", "CERTIFICADO", "COMPROBANTE",
    "CONSTANCIA", "FORMATO", "FORMULARIO", "FOTOCOPIA", "HOJA", "LICENCIA",
    "LICENCIA_DECONDUCIR", "MEMORIAL", "OBSERVACION", "PAPEL", "PASAPORTE", "RESPALDO",
    "SELLO", "TEXTO", "TITULO",
    # --- Objetos (18) ---
