...
AVAILABLE_GLOSSES = {
    ...
    "FISCALIA", "GOBIERNO", "INSTITUCION", "INTERPRETE", "JUEZ", "JUZGADO",
    "MINISTERIO", "OFICIAL", "OFICINA", "ORGANO_JUDICIAL", "POLICIA", "SEPAV",
    "TRIBUNAL", "VENTANILLA",
    # --- Conceptos jurídicos (28) ---
    "ACUERDO_SOCIAL", "ARTICULO", "AUDIENCIA", "AVANCE", "CASO", "CITACION",
    "CODIGO", "CONFIRMACION", "CONTEXTO", "DECRETO_SUPREMO", "ESTADO", "EXPEDIENTE",
    "INVESTIGACION", "JUICIO", "JUSTICIA", "LEY", "NORMA", "NOTIFICACION",
    "NUREJ", "PERSONERIA_JURIDICA", "PODER", "REGLAMENTO", "REQUISITO", "RESOLUCION",
    "SUBSANACION", "TESTIMONIO", "TRAMITE", "WEBID",
    # --- Acciones (34) ---
