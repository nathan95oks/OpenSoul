...
GLOSS_LEXICON = {
    ...
    "ABUSAR": {"rol": "VERBO", "es": "abusó sexualmente"},
    ...
    "CORRER": {"rol": "VERBO", "es": "salió corriendo"},
    ...
    "DISCRIMINACION": {"rol": "VERBO", "es": "discriminó"},
    ...
    "HOMBRE": {"rol": "DESCRIPTOR", "es": "un hombre"},
    ...
    "IDENTIDAD": {"rol": "DESCRIPTOR", "es": "mi identidad"},
    ...
    "LADRON": {"rol": "DESCRIPTOR", "es": "un ladrón"},
    ...
    "MALTRATAR": {"rol": "VERBO", "es": "maltrató"},
    ...
    "MILITAR": {"rol": "DESCRIPTOR", "es": "un militar"},
    ...
    "MUJER": {"rol": "DESCRIPTOR", "es": "una mujer"},
    ...
    "NOMBRE": {"rol": "DESCRIPTOR", "es": "mi nombre"},
    ...
    "SOBORNO": {"rol": "VERBO", "es": "ofreció un soborno"},
    "SOLDADO": {"rol": "DESCRIPTOR", "es": "un soldado"},
    ...
    "TESTIGO": {"rol": "DESCRIPTOR", "es": "un testigo"},
    ...
    "VECINO": {"rol": "DESCRIPTOR", "es": "un vecino"},
    ...
    "VIOLACION": {"rol": "VERBO", "es": "violó"},
    "VIOLENCIA": {"rol": "VERBO", "es": "ejerció violencia"},
